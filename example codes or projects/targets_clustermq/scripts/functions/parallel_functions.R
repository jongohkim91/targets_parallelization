...
read_news <- function(){
  ...
  #reading the data
  data_list <- sapply(file_list, fread, simplify = F)
  
  #marking whether is real/fake news
  data_list$`data/True.csv`[,is_real:=T]
  data_list$`data/Fake.csv`[,is_real:=F]
